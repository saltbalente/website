...
export function PopulationChart({ data, isLoading }: PopulationChartProps) {
  ...
  return (
    <div className="space-y-8">
      <div>
        <h3 className="text-lg font-medium mb-4">Top 10 Ubicaciones por Población Salvadoreña</h3>
        <div className="h-[400px]">
          <ChartContainer
            config={{
              population: {
                label: "Población Salvadoreña",
      ...
      <div>
        <h3 className="text-lg font-medium mb-4">Top 5 Estados por Población Salvadoreña</h3>
