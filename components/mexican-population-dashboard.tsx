...
import { DemographicDetails } from "@/components/demographic-details"
        ...
        <div className="lg:col-span-2">
          <Tabs defaultValue="table" className="mb-8" onValueChange={setActiveView}>
            ...
            <TabsContent value="table" className="mt-4">
              <Card>
                <CardHeader>
                  <CardTitle>Población Mexicana por Ubicación</CardTitle>
            ...
            <TabsContent value="map" className="mt-4">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Visualización de la población mexicana por región</CardDescription>
                </CardHeader>
                <CardContent>
            ...
            <TabsContent value="chart" className="mt-4">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Comparación de población mexicana entre diferentes ubicaciones</CardDescription>
                </CardHeader>
                <CardContent>
